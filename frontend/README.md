...
The prompt-first landing experience and chat history use Supabase for project storage, OAuth, and conversation replay.  
Follow the schema and setup steps in [SUPABASE.md](SUPABASE.md) to provision the required tables, storage bucket, and provider configuration.
